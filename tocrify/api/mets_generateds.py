...
#
# Generated Tue Nov  5 13:46:56 2019 by generateDS.py version 2.33.18.
# Python 3.6.7 (default, Oct 22 2018, 11:32:17)  [GCC 8.2.0]
#
# Command line options:
#   ('-f', '')
#   ('--root-element', 'mets')
#   ('-o', 'tocrify/api/mets_generateds.py')
#
# Command line arguments:
#   mets.xsd
#
# Command line:
#   /home/kmw/Documents/Work/SLUB/src/tocrify/env/bin/generateDS -f --root-element="mets" -o "tocrify/api/mets_generateds.py" mets.xsd
#
...
class metsType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, OBJID=None, LABEL=None, TYPE=None, PROFILE=None, metsHdr=None, dmdSec=None, amdSec=None, fileSec=None, structMap=None, structLink=None, behaviorSec=None, extensiontype_=None, gds_collector_=None, **kwargs_):
        ...
        self.metsHdr_nsprefix_ = None
        if dmdSec is None:
            self.dmdSec = []
        else:
            self.dmdSec = dmdSec
        self.dmdSec_nsprefix_ = None
        if amdSec is None:
            self.amdSec = []
        else:
            self.amdSec = amdSec
        self.amdSec_nsprefix_ = None
        self.fileSec = fileSec
        self.fileSec_nsprefix_ = None
        if structMap is None:
            self.structMap = []
        else:
            self.structMap = structMap
        self.structMap_nsprefix_ = None
        self.structLink = structLink
        self.structLink_nsprefix_ = None
        if behaviorSec is None:
            self.behaviorSec = []
        else:
            self.behaviorSec = behaviorSec
        self.behaviorSec_nsprefix_ = None
        self.anyAttributes_ = {}
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='metsType', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='metsType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='metsType', fromsubclass_=False, pretty_print=True):
        ...
        if self.metsHdr is not None:
            namespaceprefix_ = self.metsHdr_nsprefix_ + ':' if (UseCapturedNS_ and self.metsHdr_nsprefix_) else ''
        ...
        for dmdSec_ in self.dmdSec:
            namespaceprefix_ = self.dmdSec_nsprefix_ + ':' if (UseCapturedNS_ and self.dmdSec_nsprefix_) else ''
        ...
        for amdSec_ in self.amdSec:
            namespaceprefix_ = self.amdSec_nsprefix_ + ':' if (UseCapturedNS_ and self.amdSec_nsprefix_) else ''
        ...
        if self.fileSec is not None:
            namespaceprefix_ = self.fileSec_nsprefix_ + ':' if (UseCapturedNS_ and self.fileSec_nsprefix_) else ''
        ...
        for structMap_ in self.structMap:
            namespaceprefix_ = self.structMap_nsprefix_ + ':' if (UseCapturedNS_ and self.structMap_nsprefix_) else ''
        ...
        if self.structLink is not None:
            namespaceprefix_ = self.structLink_nsprefix_ + ':' if (UseCapturedNS_ and self.structLink_nsprefix_) else ''
        ...
        for behaviorSec_ in self.behaviorSec:
            namespaceprefix_ = self.behaviorSec_nsprefix_ + ':' if (UseCapturedNS_ and self.behaviorSec_nsprefix_) else ''
...
class amdSecType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, techMD=None, rightsMD=None, sourceMD=None, digiprovMD=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        if techMD is None:
            ...
            self.techMD = techMD
        self.techMD_nsprefix_ = None
        if rightsMD is None:
            self.rightsMD = []
        else:
            self.rightsMD = rightsMD
        self.rightsMD_nsprefix_ = None
        if sourceMD is None:
            self.sourceMD = []
        else:
            self.sourceMD = sourceMD
        self.sourceMD_nsprefix_ = None
        if digiprovMD is None:
            self.digiprovMD = []
        else:
            self.digiprovMD = digiprovMD
        self.digiprovMD_nsprefix_ = None
        self.anyAttributes_ = {}
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='amdSecType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='amdSecType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='amdSecType', fromsubclass_=False, pretty_print=True):
        ...
        for techMD_ in self.techMD:
            namespaceprefix_ = self.techMD_nsprefix_ + ':' if (UseCapturedNS_ and self.techMD_nsprefix_) else ''
        ...
        for rightsMD_ in self.rightsMD:
            namespaceprefix_ = self.rightsMD_nsprefix_ + ':' if (UseCapturedNS_ and self.rightsMD_nsprefix_) else ''
        ...
        for sourceMD_ in self.sourceMD:
            namespaceprefix_ = self.sourceMD_nsprefix_ + ':' if (UseCapturedNS_ and self.sourceMD_nsprefix_) else ''
        ...
        for digiprovMD_ in self.digiprovMD:
            namespaceprefix_ = self.digiprovMD_nsprefix_ + ':' if (UseCapturedNS_ and self.digiprovMD_nsprefix_) else ''
...
class fileGrpType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, VERSDATE=None, ADMID=None, USE=None, fileGrp=None, file=None, extensiontype_=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='fileGrpType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='fileGrpType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='fileGrpType', fromsubclass_=False, pretty_print=True):
        ...
        for fileGrp_ in self.fileGrp:
            namespaceprefix_ = self.fileGrp_nsprefix_ + ':' if (UseCapturedNS_ and self.fileGrp_nsprefix_) else ''
...
class structMapType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, TYPE=None, LABEL=None, div=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='structMapType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='structMapType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class divType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, DMDID=None, ADMID=None, TYPE=None, CONTENTIDS=None, label=None, ORDER=None, ORDERLABEL=None, LABEL=None, mptr=None, fptr=None, div=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        if mptr is None:
            ...
            self.mptr = mptr
        self.mptr_nsprefix_ = None
        if fptr is None:
            self.fptr = []
        else:
            self.fptr = fptr
        self.fptr_nsprefix_ = None
        if div is None:
            self.div = []
        else:
            self.div = div
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='divType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='divType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='divType', fromsubclass_=False, pretty_print=True):
        ...
        for mptr_ in self.mptr:
            namespaceprefix_ = self.mptr_nsprefix_ + ':' if (UseCapturedNS_ and self.mptr_nsprefix_) else ''
            mptr_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='mptr', pretty_print=pretty_print)
        for fptr_ in self.fptr:
            namespaceprefix_ = self.fptr_nsprefix_ + ':' if (UseCapturedNS_ and self.fptr_nsprefix_) else ''
...
class parType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, ORDER=None, ORDERLABEL=None, LABEL=None, area=None, seq=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='parType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='parType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class seqType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, ORDER=None, ORDERLABEL=None, LABEL=None, area=None, par=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='seqType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='seqType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class areaType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, FILEID=None, SHAPE=None, COORDS=None, BEGIN=None, END=None, BETYPE=None, EXTENT=None, EXTTYPE=None, ADMID=None, CONTENTIDS=None, ORDER=None, ORDERLABEL=None, LABEL=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='areaType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='areaType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class structLinkType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, smLink=None, smLinkGrp=None, extensiontype_=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        if smLink is None:
            ...
            self.smLink = smLink
        self.smLink_nsprefix_ = None
        if smLinkGrp is None:
            self.smLinkGrp = []
        else:
            self.smLinkGrp = smLinkGrp
        self.smLinkGrp_nsprefix_ = None
        self.anyAttributes_ = {}
        self.extensiontype_ = extensiontype_
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='structLinkType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='structLinkType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='structLinkType', fromsubclass_=False, pretty_print=True):
        ...
        for smLink_ in self.smLink:
            namespaceprefix_ = self.smLink_nsprefix_ + ':' if (UseCapturedNS_ and self.smLink_nsprefix_) else ''
        ...
        for smLinkGrp_ in self.smLinkGrp:
            namespaceprefix_ = self.smLinkGrp_nsprefix_ + ':' if (UseCapturedNS_ and self.smLinkGrp_nsprefix_) else ''
...
class behaviorSecType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, CREATED=None, LABEL=None, behaviorSec=None, behavior=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='behaviorSecType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='behaviorSecType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class behaviorType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, STRUCTID=None, BTYPE=None, CREATED=None, LABEL=None, GROUPID=None, ADMID=None, interfaceDef=None, mechanism=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.STRUCTID_nsprefix_ = None
        self.BTYPE = _cast(None, BTYPE)
        self.BTYPE_nsprefix_ = None
        if isinstance(CREATED, BaseStrType_):
            initvalue_ = datetime_.datetime.strptime(CREATED, '%Y-%m-%dT%H:%M:%S')
        else:
            initvalue_ = CREATED
        ...
        self.interfaceDef_nsprefix_ = None
        self.mechanism = mechanism
        self.mechanism_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='behaviorType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='behaviorType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='behaviorType', fromsubclass_=False, pretty_print=True):
        ...
        if self.interfaceDef is not None:
            namespaceprefix_ = self.interfaceDef_nsprefix_ + ':' if (UseCapturedNS_ and self.interfaceDef_nsprefix_) else ''
            self.interfaceDef.export(outfile, level, namespaceprefix_, namespacedef_='', name_='interfaceDef', pretty_print=pretty_print)
        if self.mechanism is not None:
            namespaceprefix_ = self.mechanism_nsprefix_ + ':' if (UseCapturedNS_ and self.mechanism_nsprefix_) else ''
...
class objectType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, LABEL=None, LOCTYPE=None, OTHERLOCTYPE=None, type_='simple', href=None, role=None, arcrole=None, title=None, show=None, actuate=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.LOCTYPE_nsprefix_ = None
        self.OTHERLOCTYPE = _cast(None, OTHERLOCTYPE)
        self.OTHERLOCTYPE_nsprefix_ = None
...
class mdSecType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, GROUPID=None, ADMID=None, CREATED=None, STATUS=None, mdRef=None, mdWrap=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.mdRef = mdRef
        self.mdRef_nsprefix_ = None
        self.mdWrap = mdWrap
        self.mdWrap_nsprefix_ = None
        self.anyAttributes_ = {}
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='mdSecType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='mdSecType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='mdSecType', fromsubclass_=False, pretty_print=True):
        ...
        if self.mdRef is not None:
            namespaceprefix_ = self.mdRef_nsprefix_ + ':' if (UseCapturedNS_ and self.mdRef_nsprefix_) else ''
        ...
        if self.mdWrap is not None:
            namespaceprefix_ = self.mdWrap_nsprefix_ + ':' if (UseCapturedNS_ and self.mdWrap_nsprefix_) else ''
...
class fileType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, SEQ=None, OWNERID=None, ADMID=None, DMDID=None, GROUPID=None, USE=None, BEGIN=None, END=None, BETYPE=None, MIMETYPE=None, SIZE=None, CREATED=None, CHECKSUM=None, CHECKSUMTYPE=None, FLocat=None, FContent=None, stream=None, transformFile=None, file=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.CHECKSUMTYPE_nsprefix_ = None
        if FLocat is None:
            self.FLocat = []
        else:
            self.FLocat = FLocat
        self.FLocat_nsprefix_ = None
        self.FContent = FContent
        self.FContent_nsprefix_ = None
        if stream is None:
            self.stream = []
        else:
            self.stream = stream
        self.stream_nsprefix_ = None
        if transformFile is None:
            self.transformFile = []
        else:
            self.transformFile = transformFile
        self.transformFile_nsprefix_ = None
        if file is None:
            self.file = []
        else:
            self.file = file
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='fileType', fromsubclass_=False, pretty_print=True):
        ...
        for FLocat_ in self.FLocat:
            namespaceprefix_ = self.FLocat_nsprefix_ + ':' if (UseCapturedNS_ and self.FLocat_nsprefix_) else ''
        ...
        if self.FContent is not None:
            namespaceprefix_ = self.FContent_nsprefix_ + ':' if (UseCapturedNS_ and self.FContent_nsprefix_) else ''
        ...
        for stream_ in self.stream:
            namespaceprefix_ = self.stream_nsprefix_ + ':' if (UseCapturedNS_ and self.stream_nsprefix_) else ''
        ...
        for transformFile_ in self.transformFile:
            namespaceprefix_ = self.transformFile_nsprefix_ + ':' if (UseCapturedNS_ and self.transformFile_nsprefix_) else ''
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'SEQ' not in already_processed:
            already_processed.add('SEQ')
            self.SEQ = self.gds_parse_integer(value, node, 'SEQ')
...
class metsHdrType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, ADMID=None, CREATEDATE=None, LASTMODDATE=None, RECORDSTATUS=None, agent=None, altRecordID=None, metsDocumentID=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.altRecordID_nsprefix_ = None
        self.metsDocumentID = metsDocumentID
        self.metsDocumentID_nsprefix_ = None
        self.anyAttributes_ = {}
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='metsHdrType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='metsHdrType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='metsHdrType', fromsubclass_=False, pretty_print=True):
        ...
        for altRecordID_ in self.altRecordID:
            namespaceprefix_ = self.altRecordID_nsprefix_ + ':' if (UseCapturedNS_ and self.altRecordID_nsprefix_) else ''
        ...
        if self.metsDocumentID is not None:
            namespaceprefix_ = self.metsDocumentID_nsprefix_ + ':' if (UseCapturedNS_ and self.metsDocumentID_nsprefix_) else ''
...
class agentType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, ROLE=None, OTHERROLE=None, TYPE=None, OTHERTYPE=None, name=None, note=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='agentType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='agentType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class altRecordIDType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, TYPE=None, valueOf_=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='altRecordIDType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='altRecordIDType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class metsDocumentIDType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='metsDocumentIDType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(self.convert_unicode(self.valueOf_))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='metsDocumentIDType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class fileSecType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, fileGrp=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='fileSecType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='fileSecType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class fileGrpType1(fileGrpType):
    ...
    def __init__(self, ID=None, VERSDATE=None, ADMID=None, USE=None, fileGrp=None, file=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='fileGrpType1', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='fileGrpType1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class structLinkType2(structLinkType):
    ...
    def __init__(self, ID=None, smLink=None, smLinkGrp=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='structLinkType2', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='structLinkType2', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class mptrType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, CONTENTIDS=None, LOCTYPE=None, OTHERLOCTYPE=None, type_='simple', href=None, role=None, arcrole=None, title=None, show=None, actuate=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='mptrType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='mptrType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class fptrType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, FILEID=None, CONTENTIDS=None, par=None, seq=None, area=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='fptrType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='fptrType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class smLinkType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, arcrole=None, title=None, show=None, actuate=None, to=None, from_=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='smLinkType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='smLinkType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class smLinkGrpType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, ARCLINKORDER='unordered', type_='extended', role=None, title=None, smLocatorLink=None, smArcLink=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.ARCLINKORDER_nsprefix_ = None
        self.type_ = _cast(None, type_)
        self.type__nsprefix_ = None
        self.role = _cast(None, role)
        self.role_nsprefix_ = None
        ...
        self.smLocatorLink_nsprefix_ = None
        if smArcLink is None:
            self.smArcLink = []
        else:
            self.smArcLink = smArcLink
        self.smArcLink_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='smLinkGrpType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='smLinkGrpType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='smLinkGrpType', fromsubclass_=False, pretty_print=True):
        ...
        for smLocatorLink_ in self.smLocatorLink:
            namespaceprefix_ = self.smLocatorLink_nsprefix_ + ':' if (UseCapturedNS_ and self.smLocatorLink_nsprefix_) else ''
        ...
        for smArcLink_ in self.smArcLink:
            namespaceprefix_ = self.smArcLink_nsprefix_ + ':' if (UseCapturedNS_ and self.smArcLink_nsprefix_) else ''
...
class smLocatorLinkType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, type_='locator', href=None, role=None, title=None, label=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='smLocatorLinkType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='smLocatorLinkType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class smArcLinkType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, ARCTYPE=None, ADMID=None, type_='arc', arcrole=None, title=None, show=None, actuate=None, from_=None, to=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='smArcLinkType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='smArcLinkType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class mdRefType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, LABEL=None, XPTR=None, LOCTYPE=None, OTHERLOCTYPE=None, type_='simple', href=None, role=None, arcrole=None, title=None, show=None, actuate=None, MDTYPE=None, OTHERMDTYPE=None, MDTYPEVERSION=None, MIMETYPE=None, SIZE=None, CREATED=None, CHECKSUM=None, CHECKSUMTYPE=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.MDTYPE_nsprefix_ = None
        self.OTHERMDTYPE = _cast(None, OTHERMDTYPE)
        self.OTHERMDTYPE_nsprefix_ = None
        self.MDTYPEVERSION = _cast(None, MDTYPEVERSION)
        self.MDTYPEVERSION_nsprefix_ = None
        self.MIMETYPE = _cast(None, MIMETYPE)
        self.MIMETYPE_nsprefix_ = None
        self.SIZE = _cast(int, SIZE)
        self.SIZE_nsprefix_ = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='mdRefType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='mdRefType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class mdWrapType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, LABEL=None, MDTYPE=None, OTHERMDTYPE=None, MDTYPEVERSION=None, MIMETYPE=None, SIZE=None, CREATED=None, CHECKSUM=None, CHECKSUMTYPE=None, binData=None, xmlData=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.binData_nsprefix_ = None
        self.xmlData = xmlData
        self.xmlData_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='mdWrapType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='mdWrapType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='mdWrapType', fromsubclass_=False, pretty_print=True):
        ...
        if self.binData is not None:
            namespaceprefix_ = self.binData_nsprefix_ + ':' if (UseCapturedNS_ and self.binData_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
        ...
        if self.xmlData is not None:
            namespaceprefix_ = self.xmlData_nsprefix_ + ':' if (UseCapturedNS_ and self.xmlData_nsprefix_) else ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'binData':
            ...
            if sval_ is not None:
                ...
                bval_ = None
            self.binData = bval_
            self.binData_nsprefix_ = child_.prefix
...
class FLocatType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, USE=None, LOCTYPE=None, OTHERLOCTYPE=None, type_='simple', href=None, role=None, arcrole=None, title=None, show=None, actuate=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='FLocatType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='FLocatType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class FContentType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, USE=None, binData=None, xmlData=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='FContentType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='FContentType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class xmlDataType3(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="http://www.w3.org/2001/XMLSchema" ', name_='xmlDataType3', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='xmlDataType3', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class streamType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, streamType_member=None, OWNERID=None, ADMID=None, DMDID=None, BEGIN=None, END=None, BETYPE=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.streamType_nsprefix_ = None
        self.OWNERID = _cast(None, OWNERID)
        self.OWNERID_nsprefix_ = None
        self.ADMID = _cast(None, ADMID)
        self.ADMID_nsprefix_ = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='streamType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='streamType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
...
class transformFileType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ID=None, TRANSFORMTYPE=None, TRANSFORMALGORITHM=None, TRANSFORMKEY=None, TRANSFORMBEHAVIOR=None, TRANSFORMORDER=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='transformFileType', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='transformFileType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'TRANSFORMORDER' not in already_processed:
            already_processed.add('TRANSFORMORDER')
            self.TRANSFORMORDER = self.gds_parse_integer(value, node, 'TRANSFORMORDER')
...
class mets(metsType):
    ...
    subclass = None
    superclass = metsType
    def __init__(self, ID=None, OBJID=None, LABEL=None, TYPE=None, PROFILE=None, metsHdr=None, dmdSec=None, amdSec=None, fileSec=None, structMap=None, structLink=None, behaviorSec=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='mets', pretty_print=True):
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='mets', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
